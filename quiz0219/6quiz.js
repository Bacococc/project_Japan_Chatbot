const quizData = [
    ...
    {
      question: "<ruby>彼女<rt>かのじょ</rt></ruby>は（　　　）な<ruby>性格<rt>せいかく</rt></ruby>で、いつも<ruby>周<rt>まわ</rt></ruby>りの<ruby>人<rt>ひと</rt></ruby>を<ruby>笑顔<rt>えがお</rt></ruby>にさせます。",
      options: ["<ruby>陰気<rt>いんき</rt></ruby>", "<ruby>朗<rt>ほが</rt></ruby>らか", "<ruby>無口<rt>むくち</rt></ruby>", "<ruby>几帳面<rt>きちょうめん</rt></ruby>"],
      correct: 1,
    }
  ];
  ...
  function checkAnswer(selectedIndex, correctIndex) {
    if (selectedIndex === correctIndex) {
      alert("정답입니다! 아래 버튼을 눌러 다음 문제로 넘어가세요.");
    } else {
  ...
  function nextQuestion() {
    ...
    if (questionCount < 4) {
      ...
      alert("문제를 모두 풀었습니다");
      questionCount = 0; // 문제를 다시 시작하려면 이 줄을 추가하세요.
    }
  }
